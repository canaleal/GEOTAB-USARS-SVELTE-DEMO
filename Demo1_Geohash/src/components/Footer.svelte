  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 mt-8">
    <div class="col-span-1">
      ...
      <p class="text-xs my-2">
        If you require any more information or have any questions about our sites disclaimer, please feel free to
    ...
    <div class="col-span-1">
      ...
      <p class="text-xs my-2">
        Welcome to the CAPSTONE API portal. The objective of this site is to make CAPSTONE data, including imagery,
